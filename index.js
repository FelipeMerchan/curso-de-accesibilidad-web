...
function validateForm(e) {
  ...
  if (nameField.value === "") {
    document.getElementById("name-error").innerHTML = "! Para enviar el formulario se requiere un nombre";
  } else {
    showNotification();
  }
}
...
/** Esta funcion se llama cuando la persona hace clic en cualquier proyecto del carousel */
